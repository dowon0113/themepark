...
//import com.business.productservice.application.service.v4.ProductServiceApiV4;
...
//public class ProductControllerApiV4 {
//
...
//        ){
//                ResProductPostDTOApiV1 responseDto = productServiceApiV4.postBy(dto);
...
//        ){
//                ResProductGetByIdDTOApiV1 responseDto = productServiceApiV4.getBy(id);
//
//                return new ResponseEntity<>(
...
//        ){
//                ResProductGetDTOApiV1 responseDto = productServiceApiV4.getBy(predicate, pageable);
//
//                return new ResponseEntity<>(
...
//        ){
//                ResProductPutDTOApiV1 responseDto = productServiceApiV4.putBy(id, dto);
//                return new ResponseEntity<>(
...
//                @PathVariable("id") UUID id
//        ){
//                productServiceApiV4.deleteBy(id);
//                return new ResponseEntity<>(
//                        ResDTO.builder()
//                                .code("0")
...
//                @PathVariable("id") UUID id
//        ){
//                productServiceApiV4.postDecreaseById(id);
//                return new ResponseEntity<>(
//                        ResDTO.builder()
//                                .code("0")
...
//                @PathVariable("id") UUID id
//        ){
//                productServiceApiV4.postRestoreById(id);
//                return new ResponseEntity<>(
//                        ResDTO.builder()
//                                .code("0")
...
//                @PathVariable("id") UUID id
//        ){
//                ResStockGetByIdDTOApiV1 responseDto = productServiceApiV4.getStockById(id);
//                return new ResponseEntity<>(
